...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_pages_blocks_hero_type" AS ENUM('default', 'fullscreen');
  ...
  CREATE TABLE "games_platform_icons" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"icon_id" integer,
  ...
  CREATE TABLE "settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"site_title" varchar DEFAULT 'Black Widow Company' NOT NULL,
  	"logo_id" integer,
  ...
  ALTER TABLE "games_platform_icons" ADD CONSTRAINT "games_platform_icons_icon_id_media_id_fk" FOREIGN KEY ("icon_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "games_platform_icons" ADD CONSTRAINT "games_platform_icons_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."games"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "games_platform_icons_order_idx" ON "games_platform_icons" USING btree ("_order");
  CREATE INDEX "games_platform_icons_parent_id_idx" ON "games_platform_icons" USING btree ("_parent_id");
  CREATE INDEX "games_platform_icons_icon_idx" ON "games_platform_icons" USING btree ("icon_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "games_platform_icons" CASCADE;
